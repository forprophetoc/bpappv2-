...
function OptionalBadge() {
  return <span className="ml-1.5 text-xs font-normal text-gray-400 tracking-normal">optional</span>;
}
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-800">Bathtub Pros — Estimate Manager</span>
        </div>
      </header>
          ...
          <CardContent className="px-5 pb-5">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <fieldset className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="beforeUrl" className="text-sm font-medium">Before Photo URL</Label>
                  <Input
                    id="beforeUrl"
                    type="url"
                    placeholder="https://..."
